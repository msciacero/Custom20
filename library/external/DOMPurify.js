...
!(function (e, t) {
  ...
  var re = (function t() {
    ...
    const o = (e) => t(e);
    if (((o.version = "3.3.1"), (o.removed = []), !n || !n.document || n.document.nodeType !== ne || !n.Element))
    ...
    let le,
      ce = "";
    const { implementation: se, createNodeIterator: ue, createDocumentFragment: me, getElementsByTagName: pe } = r,
      { importNode: fe } = a;
    let de = {
    ...
    const ht = r.createElement("form"),
      ...
      Tt = function () {
        ...
        if (!dt || dt !== e) {
          if (
            ((e && "object" == typeof e) || (e = {}),
            (e = C(e)),
            (mt = -1 === pt.indexOf(e.PARSER_MEDIA_TYPE) ? "text/html" : e.PARSER_MEDIA_TYPE),
            (ft = "application/xhtml+xml" === mt ? g : h),
            (Ne = _(e, "ALLOWED_TAGS") ? R({}, e.ALLOWED_TAGS, ft) : De),
            (Re = _(e, "ALLOWED_ATTR") ? R({}, e.ALLOWED_ATTR, ft) : we),
            (at = _(e, "ALLOWED_NAMESPACES") ? R({}, e.ALLOWED_NAMESPACES, g) : lt),
            (Qe = _(e, "ADD_URI_SAFE_ATTR") ? R(C(et), e.ADD_URI_SAFE_ATTR, ft) : et),
            (Ze = _(e, "ADD_DATA_URI_TAGS") ? R(C(Je), e.ADD_DATA_URI_TAGS, ft) : Je),
            ...
            e.FORBID_CONTENTS && (Ke === Ve && (Ke = C(Ke)), R(Ke, e.FORBID_CONTENTS, ft)),
            e.ADD_FORBID_CONTENTS && (Ke === Ve && (Ke = C(Ke)), R(Ke, e.ADD_FORBID_CONTENTS, ft)),
            Xe && (Ne["#text"] = !0),
      ...
      bt = function (e) {
        ...
        return (
          ...
          rt === ot ? pe.call(t, Pe ? "html" : "body")[0] : Pe ? t.documentElement : i
        );
      },
      St = function (e) {
        return ue.call(
    ...
    const wt = function (e) {
        ...
        if (!(xe.tagCheck instanceof Function && xe.tagCheck(n)) && (!Ne[n] || Oe[n])) {
          if (!Oe[n] && Ot(n)) {
            if (Ce.tagNameCheck instanceof RegExp && b(Ce.tagNameCheck, n)) return !1;
        ...
        return e instanceof w &&
          ...
          ? (At(e), !0)
          : ("noscript" !== n && "noembed" !== n && "noframes" !== n) || !b(/<\/no(script|embed|frames)/i, e.innerHTML)
          ? (Ue &&
              e.nodeType === Q &&
              ((t = e.textContent),
              u([he, ge, Te], (e) => {
              ...
              e.textContent !== t && (f(o.removed, { element: e.cloneNode() }), (e.textContent = t))),
            Rt(de.afterSanitizeElements, e, null),
            !1)
          : (At(e), !0);
      },
      Ct = function (e, t, n) {
        if (Ye && ("id" === t || "name" === t) && (n in r || n in ht)) return !1;
        if (ke && !ve[t] && b(ye, t));
        else if (Le && b(Ee, t));
        else if (xe.attributeCheck instanceof Function && xe.attributeCheck(t, e));
        else if (!Re[t] || ve[t]) {
          if (
            !(
              (Ot(e) &&
                ((Ce.tagNameCheck instanceof RegExp && b(Ce.tagNameCheck, e)) ||
                  (Ce.tagNameCheck instanceof Function && Ce.tagNameCheck(e))) &&
                ((Ce.attributeNameCheck instanceof RegExp && b(Ce.attributeNameCheck, t)) ||
                  (Ce.attributeNameCheck instanceof Function && Ce.attributeNameCheck(t, e)))) ||
              ("is" === t &&
      ...
      vt = function (e) {
        ...
        if (!t || Nt(e)) return;
        const n = { attrName: "", attrValue: "", keepAttr: !0, allowedAttributes: Re, forceKeepAttr: void 0 };
        let r = t.length;
        for (; r--; ) {
          const i = t[r],
          ...
          if (
            ...
            (f = n.attrValue),
            !je || ("id" !== s && "name" !== s) || (_t(a, e), (f = "user-content-" + f)),
          ...
          if (Ct(d, s, f)) {
            ...
            if (f !== m)
              try {
                l ? e.setAttributeNS(l, a, f) : e.setAttribute(a, f), Nt(e) ? At(e) : p(o.removed);
              } catch (t) {
                _t(a, e);
              }
          } else _t(a, e);
    ...
    return (
      (o.sanitize = function (e) {
        let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
          ...
          i = null,
          l = null;
        if (((it = !e), it && (e = "\x3c!--\x3e"), "string" != typeof e && !Dt(e))) {
        ...
        if ((Fe || Tt(t), (o.removed = []), "string" == typeof e && (qe = !1), qe)) {
          if (e.nodeName) {
            const t = ft(e.nodeName);
            if (!Ne[t] || Oe[t]) throw S("root node is forbidden and cannot be sanitized in-place");
          }
        } else if (e instanceof D)
          (n = bt("\x3c!----\x3e")),
            (r = n.ownerDocument.importNode(e, !0)),
            (r.nodeType === J && "BODY" === r.nodeName) || "HTML" === r.nodeName ? (n = r) : n.appendChild(r);
        else {
          if (!Be && !Ue && !Pe && -1 === e.indexOf("<")) return le && We ? le.createHTML(e) : e;
          if (((n = bt(e)), !n)) return Be ? null : We ? ce : "";
        }
        n && He && At(n.firstChild);
        const c = St(qe ? e : n);
        for (; (i = c.nextNode()); ) wt(i), vt(i), i.content instanceof s && xt(i.content);
        if (qe) return e;
        if (Be) {
          if (Ge) for (l = me.call(n.ownerDocument); n.firstChild; ) l.appendChild(n.firstChild);
          else l = n;
      ...
      (o.setConfig = function () {
        Tt(arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}), (Fe = !0);
      }),
